...
int disttbfast( int ngui, int lgui, int mgui, char **namegui, char **seqgui, char **msggui, int argc, char *argv[] )
{
	static int  *nlen;	
	static int  *nogaplen;	
...
//--------------- kokomade ----
	...
	reporterr(       "Progressive alignment ... \n" );
...
{
	disttbfast( 0, 0, 0, NULL, NULL, NULL, argc, argv );
}
